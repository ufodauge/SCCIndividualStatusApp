...
namespace SCCIndividualStatusApp
{
  public partial class MainForm : Form
  {
    ...
    private void SpreadsheetUrlTextBox_TextChanged(object sender, EventArgs e)
    {

    }

    private void IncludeTodayCheckBox_CheckedChanged(object sender, EventArgs e)
    {
    ...
    {
      // URLのバリデーション
      string url = SpreadsheetUrlTextBox.Text.Trim();
      ...
      byte[] fileData = DownloadXlsxFromSpreadsheetById(sheetId);
      ...
      using (var stream = new MemoryStream(fileData))
      {
        ...
        do
        {
          ...
          // クラスのフォルダを用意
          var classDirectory = path + $@"{reader.Name}/";
          ...
          foreach (var studentData in studentDataList)
          {
            var fileName = RemoveInvalidFileNameChars(
              $"{studentData.ClassNumber}組{studentData.StudentNumber}番" +
              $"_{studentData.Name}");
                  ...
                  .Column(x =>
                  {
                    ...
                    x.Item()
                      ...
                      .Row(row =>
                      {
                        ...
                        row.ConstantItem(COL_TEST_REESUT_SPAN_PX)
                          .AlignCenter()
                          .Text(string.Format("{0:f1}", studentData.GetTestResultAverage()));
                      });
                  });
              });
    ...
    private byte[] DownloadXlsxFromSpreadsheetById(string sheetId)
    {
    ...
    {
      LogTextBox.Focus();
      LogTextBox.AppendText($"[{DateTime.Now.ToString("T")}] {log}\n");
    }
    ...
    private void MainForm_Load(object sender, EventArgs e)
    {
      ...
      SpreadsheetUrlTextBox.Text = "https://docs.google.com/spreadsheets/d/XXXXXXXXXX";
